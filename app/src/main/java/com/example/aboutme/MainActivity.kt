...
class MainActivity : AppCompatActivity() {
    ...
    private fun addNickname() {
        //tinanggal na mga find view by

        binding.apply {
            myName?.nickname = nicknameEdit.text.toString() //kinukuha value ng nickname
            invalidateAll() //refresh ui with new data // kada change lagay to
            binding.nicknameEdit.visibility = View.GONE

            binding.doneButton.visibility = View.GONE

            //show text view for nickname
